 ...
 */
export async function askGemini({ systemPrompt, history = [], userMessage, attachment, responseMimeType }) {
  ...
  const model = attachment ? 'gemini-3.5-flash' : (process.env.GEMINI_MODEL || DEFAULT_MODEL)
