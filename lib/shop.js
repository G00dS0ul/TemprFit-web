...
export const SHOP_ITEMS = [
  ...
  { id: 'border_fire', name: 'Fire Aura', desc: 'Glowing animated avatar border (7 days)', type: 'border', value: 'fire', durationDays: 7, cost: 20, icon: Sparkles, category: 'cosmetic' },
