...
const SCENES = [
  {
    ...
    cta: 'Start Training',
    href: '/register',
    dark: '/images/hero/scene-1-male-pushup-dark.jpg',
    light: '/images/hero/scene-1-male-pushup-light.jpg',
  },
  {
    ...
    href: '/explore',
    dark: '/images/hero/scene-2-female-pushup-dark.jpg',
    light: '/images/hero/scene-2-male-seated-light.jpg',
  },
  {
    ...
    cta: 'View Progress',
    href: '/progress',
    dark: '/images/hero/scene-3-male-deadlift-dark.jpg',
    light: '/images/hero/scene-3-male-deadlift-light.jpg',
  },
  {
    ...
    cta: 'Meet Your Coach',
    href: '/coach',
    dark: '/images/hero/scene-4-male-seated-dark.jpg',
    light: '/images/hero/scene-1-male-pushup-light.jpg',
  },
];
